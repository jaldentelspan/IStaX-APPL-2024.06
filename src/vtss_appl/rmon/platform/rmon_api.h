...
#define DATASOURCE_MGMT_PORTID_START        0
#define DATASOURCE_IFINDEX_SWITCH_INTERVAL  VTSS_IFINDEX_UNIT_MULTP
#define DATASOURCE_IFINDEX_GLAG_START       VTSS_IFINDEX_GLAG_OFFSET
#define DATASOURCE_IFINDEX_GLAG_END         (VTSS_IFINDEX_VLAN_OFFSET - 1)
#define DATASOURCE_IFINDEX_LPOAG_START      0
#define DATASOURCE_IFINDEX_LPOAG_END        (((VTSS_ISID_CNT - 1) * IFTABLE_IFINDEX_SWITCH_INTERVAL) - 1)
#define DATASOURCE_IFINDEX_END              0xFFFFFFFF
...
#define    DATASOURCE_IFINDEX_TYPE_PORT     0
#define    DATASOURCE_IFINDEX_TYPE_LLAG     1
#define    DATASOURCE_IFINDEX_TYPE_GLAG     2
#define    DATASOURCE_IFINDEX_TYPE_VLAN     3
#define    DATASOURCE_IFINDEX_TYPE_IP       4
#define    DATASOURCE_IFINDEX_TYPE_UNDEF    5
...
typedef enum {
    ...
    RMON_ERROR_INVALID_PARAM,                                 /* Invalid parameter */
    ...
    RMON_ERROR_STACK_STATE,                                   /* Illegal primary/secondary switch state */
} rmon_error_t;
...
#else
mesa_rc rmon_mgmt_event_data_get ( vtss_history_data_entry_t *entry, BOOL next );
#endif
