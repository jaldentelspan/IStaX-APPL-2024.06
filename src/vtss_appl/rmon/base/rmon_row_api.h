...
typedef void (ROWAPIAlarmCallback)(unsigned int clientreg, void *clientarg);
#define MAX_OWNERSTRING     128

#define ROW_ERR_NOERROR SNMP_ERR_NOERROR
#define ROW_ERR_TOOBIG SNMP_ERR_TOOBIG
#define ROW_ERR_NOSUCHNAME SNMP_ERR_NOSUCHNAME
#define ROW_ERR_BADVALUE SNMP_ERR_BADVALUE
#define ROW_ERR_GENERR SNMP_ERR_GENERR
...
void rowapi_delete(RMON_ENTRY_T *eold);
