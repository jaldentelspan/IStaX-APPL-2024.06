...
typedef VTSS_COMMON_PTR_ATTRIB struct vtss_lacp_aggregator_vars {
    ...
    vtss_common_octet_t         num_of_hw_ports; // actual number of HW aggregated ports
...
typedef VTSS_COMMON_PTR_ATTRIB struct vtss_lacp_group_vars {
    BOOL revertive;
    u32 max_bundle;
} vtss_lacp_group_vars_t;
...
typedef VTSS_COMMON_PTR_ATTRIB struct {
    ...
    /* Private fields not covered in standard */
    CapArray<vtss_lacp_aggregator_vars_t, MEBA_CAP_BOARD_PORT_MAP_COUNT> aggregators;
    CapArray<vtss_lacp_port_vars_t, MEBA_CAP_BOARD_PORT_MAP_COUNT> ports;
    CapArray<vtss_lacp_group_vars_t, MEBA_CAP_BOARD_PORT_MAP_COUNT> key_config;
