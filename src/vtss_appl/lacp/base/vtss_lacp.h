...
#define VTSS_LACP_DEFAULT_REVERTIVE     VTSS_COMMON_BOOL_TRUE

#include "vtss_lacp_os.h"

#if defined(AGGR_MGMT_LAG_PORTS_MAX)
#define VTSS_LACP_MAX_PORTS_IN_AGGR     (AGGR_MGMT_LAG_PORTS_MAX_) /* Max number of ports in a Aggregation group */
#else
#define VTSS_LACP_MAX_PORTS_IN_AGGR     (fast_cap(MEBA_CAP_BOARD_PORT_MAP_COUNT))   /* No limit */
#endif

#define VTSS_LACP_MAX_AGGR              (VTSS_LACP_MAX_PORTS) /* Max number of Aggregation groups */
#define VTSS_LACP_MAX_AGGR_             (VTSS_LACP_MAX_PORTS_) /* Max number of Aggregation groups */
...
typedef VTSS_COMMON_DATA_ATTRIB struct {
    ...
    mesa_port_list_t port_list; /* True for each port on this aggr */
...
typedef VTSS_COMMON_DATA_ATTRIB struct {
    ...
    vtss_lacp_portstate_t actor_lacp_state;
    vtss_lacp_portstate_t partner_lacp_state;
...
extern void vtss_lacp_set_groupconf(vtss_lacp_key_t key,
                                    const vtss_lacp_groupconfig_t *config);

/* Get the group config  */
extern void vtss_lacp_get_groupconf(vtss_lacp_key_t key,
