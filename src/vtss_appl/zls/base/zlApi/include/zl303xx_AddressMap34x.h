...
*
*  Module Description:
*     Values and constants for the ZLS3034X device internal address map
*
*******************************************************************************/

#ifndef ZL303XX_ADDRESS_MAP_34X_H_
#define ZL303XX_ADDRESS_MAP_34X_H_
...
#else
#define ZL303XX_ADDR_PAGE_REG      ZL303XX_MAKE_MEM_ADDR(0x00, 0x75, ZL303XX_MEM_SIZE_1_BYTE, ZL303XX_MEM_OVRLY_NONE)
#endif
