...
/**
  ...
  Function Name:    osGetIpAddr

  Details:  gets the IP address for the given interface string

  Parameters:
   [in]  ifName          Name of the network interface.
   [out] ipAddress       String buffer for output of size ipAddressLen bytes.
   [in]  ipAddressLen    Length in bytes of ipAddress buffer.

  Return Value:
   0 for success

*******************************************************************************/
Sint32T osGetIpAddr(const char *ifName, char *ipAddress, Uint32T ipAddressLen);

/**

  Function Name:    osGetIpAddr6

  Details:  gets the IPv6 address for the given interface string
...
*******************************************************************************/
Sint32T osGetIpAddr6(const char *ifName, char *ipAddress, Uint32T ipAddressLen);
