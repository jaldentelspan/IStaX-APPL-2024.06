...
#include "zl_30341_api_api.h"
#include "zl_30341_api.h"
...
mesa_rc zl_3034x_register_get(const u32   page,
                              const u32   reg,
                              u32 *const  value)
{
    *value = 0;
...
mesa_rc zl_3034x_register_set(const u32   page,
                              const u32   reg,
                              const u32   value)
{
...
mesa_rc zl_3034x_debug_pll_status(void)
{
...
mesa_rc zl_3034x_debug_hw_ref_status(u32 ref_id)
{
    mesa_rc rc = VTSS_RC_OK;
...
mesa_rc zl_3034x_debug_hw_ref_cfg(u32 ref_id)
{
    mesa_rc rc = VTSS_RC_OK;
...
mesa_rc zl_3034x_debug_dpll_status(u32 pll_id)
{
    mesa_rc rc = VTSS_RC_OK;
...
mesa_rc zl_3034x_debug_dpll_cfg(u32 pll_id)
{
    mesa_rc rc = VTSS_RC_OK;
...
mesa_rc zl_3034x_debug_dco_freq_read(i32* freqOffsetUppm)
{
    mesa_rc rc = VTSS_RC_OK;

    if (zl303xx_DcoGetFreq(zl_3034x_zl303xx_params, freqOffsetUppm) != ZL303XX_OK) {
        T_D("Error during Zarlink dpll cfg get");
        rc = VTSS_RC_ERROR;
    }
...
mesa_rc zl_3034x_trace_init(FILE *logFd)
{
...
mesa_rc zl_3034x_trace_level_module_set(u32 module, u32 level)
{
...
mesa_rc zl_3034x_trace_level_all_set(u32 level)
{
