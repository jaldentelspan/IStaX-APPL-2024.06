...
zlStatusE zl303xx_Ref77xBaseFreqSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T freqHz)
{
    ...
    if (status == ZL303XX_OK)
    {
        multistepMutexStatus = zl303xx_Dpll77xMutexesTake(zl303xx_Params, ZL303XX_77X_PROTECT_MULTISTEP_PROCESS_DATA, __FUNCTION__, &status);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetupMailboxForWrite(zl303xx_Params, ZLS3077X_MB_ref, refId);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL,
                            ZL303XX_MAKE_MEM_ADDR_77X(ZLS3077X_REFX_FREQ_BASE_REG,ZL303XX_MEM_SIZE_2_BYTE),
                            freqHz);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_ref);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xUpdateMailboxCopy(zl303xx_Params, ZLS3077X_MB_ref, refId);
    }
    if (multistepMutexStatus == ZL303XX_OK)
    {
        multistepMutexStatus = zl303xx_Dpll77xMutexesGive(zl303xx_Params, ZL303XX_77X_PROTECT_MULTISTEP_PROCESS_DATA, __FUNCTION__, &status);
    }
...
zlStatusE zl303xx_Ref77xFreqMultipleSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T multiple)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    {
        status = zl303xx_Write(zl303xx_Params, NULL,
                            ZL303XX_MAKE_MEM_ADDR_77X(ZLS3077X_REFX_FREQ_MULT_REG,ZL303XX_MEM_SIZE_2_BYTE),
                            multiple);
    }
    if (status == ZL303XX_OK)
    {
...
zlStatusE zl303xx_Ref77xRatioMRegSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T M)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    {
        status = zl303xx_Write(zl303xx_Params, NULL,
                ZL303XX_MAKE_MEM_ADDR_77X(ZLS3077X_REFX_RATIO_M_REG,ZL303XX_MEM_SIZE_2_BYTE),
                M);
    }
    if (status == ZL303XX_OK)
    {
...
zlStatusE zl303xx_Ref77xRatioNRegSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T N)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    {
        status = zl303xx_Write(zl303xx_Params, NULL,
                ZL303XX_MAKE_MEM_ADDR_77X(ZLS3077X_REFX_RATIO_N_REG,ZL303XX_MEM_SIZE_2_BYTE),
                N);
    }
    if (status == ZL303XX_OK)
    {
...
zlStatusE zl3077x_DpllRefPrioritySet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, zl303xx_RefIdE refId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint32T regVal = 0;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetupMailboxForRead(zl303xx_Params, ZLS3077X_MB_DPLL, dpllId);
    }
    if (status == ZL303XX_OK)
    {
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetupMailboxForWrite(zl303xx_Params, ZLS3077X_MB_DPLL, dpllId);
    }
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
    }

    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xUpdateMailboxCopy(zl303xx_Params, ZLS3077X_MB_DPLL, dpllId);
    }
    if (multistepMutexStatus == ZL303XX_OK)
    {
        multistepMutexStatus = zl303xx_Dpll77xMutexesGive(zl303xx_Params, ZL303XX_77X_PROTECT_MULTISTEP_PROCESS_DATA, __FUNCTION__, &status);
...
zlStatusE zl3077x_DpllRefPriorityGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, zl303xx_RefIdE refId, Uint32T *val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint32T regValue = 0;
...
zlStatusE zl303xx_Ref77xCfmLimitSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_REFX_CFM_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_ref);
    ...
    return status;
}  /* END zl303xx_Ref77xCfmLoLimitSet */


/**

  Function Name:
   zl303xx_Ref77xScmLimitSet
...
zlStatusE zl303xx_Ref77xScmLimitSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint32T regVal = 0;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Read(zl303xx_Params, NULL, ZLS3077X_REFX_SCM_REG, &regVal);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetupMailboxForWrite(zl303xx_Params, ZLS3077X_MB_ref, refId);
    ...
    if (status == ZL303XX_OK)
    {
        ZL303XX_INSERT(regVal, val,
                          0x7,
                          0);
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_REFX_SCM_REG, regVal);
    }
    if (status == ZL303XX_OK)
    {
...
/**
   Function Name:
    zl303xx_Ref77xGstDisqualifyTimeSet
...
zlStatusE zl303xx_Ref77xGstDisqualifyTimeSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_REFX_GST_DISQUAL_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_ref);
    ...
    return status;
}  /* END zl303xx_Ref77xGstDisqualifyTimeSet */


/**
   Function Name:
    zl303xx_Ref77xGstQualifyTimeSet
...
zlStatusE zl303xx_Ref77xGstQualifyTimeSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_REFX_GST_QUAL_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_ref);
    ...
    return status;
}  /* END zl303xx_Ref77xGstQualifyTimeSet */


/**
   Function Name:
    zl303xx_Ref77xPfmLimitSet
...
zlStatusE zl303xx_Ref77xPfmLimitSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_REFX_PFM_FILTER_LIMIT_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_ref);
    ...
    return status;
}  /* END zl303xx_Ref77xPfmLimitSet */

/**
   Function Name:
    zl303xx_Ref77xDpllPhaseSlopeLimitSet
...
zlStatusE zl303xx_Ref77xDpllPhaseSlopeLimitSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_PSL_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
    ...
    return status;
}  /* END zl303xx_Ref77xDpllPhaseSlopeLimitSet */

/**
   Function Name:
    zl3077x_DpllHoldoverDelayStorageSet
...
zlStatusE zl3077x_DpllHoldoverDelayStorageSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_HO_DELAY_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
...
/**
   Function Name:
    zl3077x_DpllHoldoverFilterBandwidthSet
...
zlStatusE zl3077x_DpllHoldoverFilterBandwidthSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_HO_FILTER_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
...
/**
   Function Name:
    zl303xx_Ref77xDpllVariableLowBandwidthSelectSet
...
zlStatusE zl303xx_Ref77xDpllVariableLowBandwidthSelectSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_BW_VAR_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
    ...
    return status;
}  /* END zl303xx_Ref77xDpllVariableLowBandwidthSelectSet */


/**
   Function Name:
    zl303xx_Ref77xSynthEnableSet
...
zlStatusE zl303xx_Ref77xSynthEnableSet(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, zl303xx_BooleanE val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = ZLS3077X_CHECK_SYNTH_ID(synthId);
        if (status == ZL303XX_OK && synthId == ZLS3077X_GP_SYNTHID) {
    ...
    return status;
}  /* END zl303xx_Ref77xSynthEnableSet */
...
zlStatusE zl303xx_Ref77xSynthDrivePll(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, zl303xx_DpllIdE dpllId)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
...
zlStatusE zl303xx_Ref77xSynthBaseFreqSet(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, Uint32T freqHz)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint32T   regAddr = 0;
    ...
    if (status == ZL303XX_OK)
    {
        if (synthId == ZLS3077X_GP_SYNTHID) {
            if (status == ZL303XX_OK)
            {
                //status = ((freqHz <= 0xFFFFU) && (1600000000UL % freqHz == 0)) ? ZL303XX_OK : ZL303XX_PARAMETER_INVALID;
                regAddr = ZLS3077X_GP_FREQ_BASE_REG; 
            }
        } else {
            ...
            if (status == ZL303XX_OK)
            {
                ...
                regAddr = ZLS3077X_HP_FREQ_BASE_REG(synthId);
            }
        }
        if (status == ZL303XX_OK)
        {
...
zlStatusE zl303xx_Ref77xSynthRatioMRegSet(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, Uint32T M)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint32T regAddr = 0;
    ...
    if (synthId == ZLS3077X_GP_SYNTHID) {
        ...
        {
            status = (M <= 0xFFFFU) ? ZL303XX_OK : ZL303XX_PARAMETER_INVALID;
            regAddr = ZLS3077X_GP_FREQ_M_REG;
        }
    } else {
        if (status == ZL303XX_OK)
        {
            status = (M <= 0xFFFFFFFFU) ? ZL303XX_OK : ZL303XX_PARAMETER_INVALID;
            regAddr = ZLS3077X_HP_FREQ_M_REG(synthId);
        }
    }
...
zlStatusE zl303xx_Ref77xSynthRatioNRegSet(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, Uint32T N)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint32T regAddr = 0;
    ...
    if (synthId == ZLS3077X_GP_SYNTHID) {
        ...
        {
            status = ((N >= 1) && (N <= 0xFFFFU)) ? ZL303XX_OK : ZL303XX_PARAMETER_INVALID;
            regAddr = ZLS3077X_GP_FREQ_N_REG;
        }
    } else {
        if (status == ZL303XX_OK)
        {
            status = ((N >= 1) && (N <= 0xFFFFFFFFU)) ? ZL303XX_OK : ZL303XX_PARAMETER_INVALID;
            regAddr = ZLS3077X_HP_FREQ_N_REG(synthId);
        }
    }
...
zlStatusE zl303xx_Ref77xHpFormatSet(zl303xx_ParamsS *zl303xx_Params, Uint32T outId, zl303xx_Ref77xHpFormat_t format)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        status = ZLS3077X_CHECK_OUT_ID(outId);
    }
    ...
    if (status == ZL303XX_OK)
    {
        if (status == ZL303XX_OK)
        {
            ...
            status = zl303xx_ReadModWrite(zl303xx_Params, NULL,
                         ZLS3077X_HP_OUT_CTRL_REG(outId),
...
*******************************************************************************/
zlStatusE zl303xx_Ref77xSynthHsDivSet(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK && synthId != ZLS3077X_GP_SYNTHID)
    {
        ...
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_HP_HSDIV_REG(synthId), val);
        if (multistepMutexStatus == ZL303XX_OK)
        {
            multistepMutexStatus = zl303xx_Dpll77xMutexesGive(zl303xx_Params, ZL303XX_77X_PROTECT_MULTISTEP_PROCESS_DATA, __FUNCTION__, &status);
        }
...
/**
   Function Name:
   zl303xx_Ref77xSynthFracDivBaseSet
...
*******************************************************************************/
zlStatusE zl303xx_Ref77xSynthFracDivBaseSet(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        ...
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_HP_FDIV_BASE_REG(synthId), val);
        if (multistepMutexStatus == ZL303XX_OK)
        {
            multistepMutexStatus = zl303xx_Dpll77xMutexesGive(zl303xx_Params, ZL303XX_77X_PROTECT_MULTISTEP_PROCESS_DATA, __FUNCTION__, &status);
        }
...
*******************************************************************************/
zlStatusE zl303xx_Ref77xHpMsDiv(zl303xx_ParamsS *zl303xx_Params, Uint32T outId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        ...
        status = zl303xx_Write(zl303xx_Params, NULL,ZLS3077X_HP_OUT_MSDIV_REG(outId),val);
        if (multistepMutexStatus == ZL303XX_OK)
        {
            multistepMutexStatus = zl303xx_Dpll77xMutexesGive(zl303xx_Params, ZL303XX_77X_PROTECT_MULTISTEP_PROCESS_DATA, __FUNCTION__, &status);
        }
...
/**
   Function Name:
   zl303xx_Ref77xHpEnableSet

   Details:
    Configures the HP General enable flag (reg 4.04e0)

   Parameters:
    [in]    zl303xx_Params Pointer to the device instance parameter structure
    [in]    outId          The output to disable/enable (0-7)
    [in]    enable         Value for disabling or enabling output

   Return Value:
    zlStatusE

*******************************************************************************/
zlStatusE zl303xx_Ref77xHpEnableSet(zl303xx_ParamsS *zl303xx_Params, Uint32T outId, zl303xx_BooleanE enable)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint8T val = 0;
    ...
    if (status == ZL303XX_OK)
    {
        ...
        status = zl303xx_ReadModWrite(zl303xx_Params, NULL,
                         ZL303XX_HP_OUT_ENABLE(outId),
                         val, (Uint8T)(1 << outId), NULL);
...
*******************************************************************************/
zlStatusE zl303xx_Ref77xHpLsDiv(zl303xx_ParamsS *zl303xx_Params, Uint32T outId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        ...
        if (status == ZL303XX_OK)
        {
            status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_HP_OUT_LSCTRL_REG(outId),(val>1)<<ZLS3077X_HP_OUT_LSCTRL_NEGLSD_SHIFT | (val>1)<<ZLS3077X_HP_OUT_LSCTRL_LSSEL_SHIFT);
        }
        
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_HP_OUT_LSDIV_REG(outId),val);
        if (multistepMutexStatus == ZL303XX_OK)
        {
            multistepMutexStatus = zl303xx_Dpll77xMutexesGive(zl303xx_Params, ZL303XX_77X_PROTECT_MULTISTEP_PROCESS_DATA, __FUNCTION__, &status);
        }
...
zlStatusE zl3077x_RefIsrStatusGet(zl303xx_ParamsS *zl303xx_Params,
   ...
   /* .Read sticky registers */
    if (status == ZL303XX_OK)
    {
        ...
        status = zl303xx_Read(zl303xx_Params, NULL,
                ZLS3077X_REF_MON_FAIL_REG(par->Id),
                &regValue2);
    }
    if (multistepMutexStatus == ZL303XX_OK)
    {
...
zlStatusE zl3077x_RefIsrConfigGet(zl303xx_ParamsS *zl303xx_Params,
                                  zl303xx_RefIsrConfigS *par)
{
    ...
    {
       status = zl303xx_Read(zl303xx_Params, NULL,
                             ZLS3077X_REF_IRQ_MASK_REG(par->Id),
                             &regValue);
    }
    ...
    {
       status = zl303xx_Read(zl303xx_Params, NULL,
                             ZLS3077X_REF_MON_TH_MASK_REG(par->Id),
                             &regValue);
    }
    if (multistepMutexStatus == ZL303XX_OK)
    {
...
zlStatusE zl3077x_RefIsrConfigSet(zl303xx_ParamsS *zl303xx_Params,
                                  zl303xx_RefIsrConfigS *par)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
   ...
   //    status = zl303xx_Write(zl303xx_Params, NULL,
   //                               ZLS3077X_GPIO_IRQ_CONFIG_REG,
   //                               0x1);
   //    /* select GPIO_0 for IRQ */
   //    status = zl303xx_Write(zl303xx_Params, NULL,
   //                               ZLS3077X_GPIO_CONFIG_0_REG,
   //                               0x4);
   //}
    if (status == ZL303XX_OK)
    {
    ...
    if (status == ZL303XX_OK)
    {
       ...
       if (par->Id > 7) {
       status = zl303xx_ReadModWrite(zl303xx_Params, NULL,
                                     ZLS3077X_REF_IRQ_MASK_4_REG,
                                     par->refIsrEn ? 1<<(par->Id - 8) : 0,1<<(par->Id - 8), NULL);
       } else {
       status = zl303xx_ReadModWrite(zl303xx_Params, NULL,
                                     ZLS3077X_REF_IRQ_MASK_3_0_REG,
...
/*
  ...
  Function Name:
   zl303xx_Ref77xDpllIsrStatusGet
...
zlStatusE zl303xx_Ref77xDpllIsrStatusGet(zl303xx_ParamsS *zl303xx_Params,
                                zl303xx_DpllStatusS *par)
{
    ...
    if (status == ZL303XX_OK)
    {
       ...
       status = zl303xx_Read(zl303xx_Params, NULL,
                             ZLS3077X_DPLL_MON_STATUS_REG(par->Id),
                             &regValue2);
    ...
    par->holdover = (zl303xx_DpllHoldStateE)ZL303XX_EXTRACT(regValue2,
            ZLS3077X_DPLL_MON_STICKY_HOLDOVER_MASK,
            ZLS3077X_DPLL_MON_STICKY_HOLDOVER_SHIFT);

    par->locked = (zl303xx_DpllLockStateE)ZL303XX_EXTRACT(regValue2,
            ZLS3077X_DPLL_MON_STICKY_LOCKED_MASK,
            ZLS3077X_DPLL_MON_STICKY_LOCKED_SHIFT);

    return status;
} /* END zl303xx_Ref77xDpllIsrStatusGet */

/**

  Function Name:
   zl303xx_Ref77xDpllIsrMaskGet
...
zlStatusE zl303xx_Ref77xDpllIsrMaskGet(zl303xx_ParamsS *zl303xx_Params,
                                   zl303xx_DpllIsrConfigS *par)
{
    ...
    else
    {
        ...
        {
            status = zl303xx_Read(zl303xx_Params, NULL,
                                      ZLS3077X_DPLL_MON_TH_MASK_REG(par->Id),
                                      &regValue);
        }
        ...
        if (status == ZL303XX_OK)
        {
            par->lockIsrEn = (zl303xx_BooleanE)ZL303XX_EXTRACT(regValue,
                                                   ZLS3077X_DPLL_MON_MASK_LOCKED_MASK,
                                                   ZLS3077X_DPLL_MON_MASK_LOCKED_SHIFT);
            ...
            /* For Zl3077x there is not feild that specify that there is a Loss of lock */
            par->lostLockIsrEn = (zl303xx_BooleanE)!(par->lockIsrEn);

            par->holdoverIsrEn = (zl303xx_BooleanE)ZL303XX_EXTRACT(regValue,
                                                       ZLS3077X_DPLL_MON_MASK_HOLDOVER_MASK,
                                                       ZLS3077X_DPLL_MON_MASK_HOLDOVER_SHIFT);
        }
    ...
    return status;
} /* END zl303xx_Ref77xDpllIsrMaskGet */

/**

  Function Name:
   zl303xx_Ref77xDpllIsrMaskSet
...
zlStatusE zl303xx_Ref77xDpllIsrMaskSet(zl303xx_ParamsS *zl303xx_Params,
                                   zl303xx_DpllIsrConfigS *par)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        ...
        if (status == ZL303XX_OK)
        {
            status = zl303xx_Dpll77xSetupMailboxForWrite(zl303xx_Params, ZLS3077X_MB_DPLL, par->Id);
        }
        if (status == ZL303XX_OK)
        {
            status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_REF_SW_MASK_REG, 0x3f);
            status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_REF_HO_MASK_REG, 0x3f);
        }
        if (status == ZL303XX_OK)
        {
            status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
        ...
        if (status == ZL303XX_OK)
        {
            status = zl303xx_Dpll77xUpdateMailboxCopy(zl303xx_Params, ZLS3077X_MB_DPLL, par->Id);
        }
       ...
       //                       ZL303XX_DPLL_ISR_MASK_LOST_LOCK_SHIFT(par->Id));
        ...
        mask |= (ZLS3077X_DPLL_MON_MASK_LOCKED_MASK << ZLS3077X_DPLL_MON_MASK_LOCKED_SHIFT) |
                (ZLS3077X_DPLL_MON_MASK_HOLDOVER_MASK << ZLS3077X_DPLL_MON_MASK_HOLDOVER_SHIFT);
    ...
    return status;
} /* END zl303xx_Ref77xDpllIsrMaskSet */

zlStatusE zl303xx_Ref77xLosStateSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T los)
{
    zlStatusE status = ZL303XX_OK;
    ...
    if (status == ZL303XX_OK)
    {
        if (refId <= 7)
        {
           regAddr  = ZLS3077X_REF_LOS_3_0_REG;
           bitShift = refId;
        }
        else
        {
           regAddr  = ZLS3077X_REF_LOS_4_REG;
           bitShift = refId - 8;
        }
...
/**
   Function Name:
    zl303xx_Ref77xDpllFastLockMasterEnableSet
...
zlStatusE zl303xx_Ref77xDpllFastLockMasterEnableSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    Uint32T regVal = 0;
    ...
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Read(zl303xx_Params, NULL, ZLS3077X_DPLLX_FAST_LOCK_CTRL_REG, &regVal);
    }
    ...
    if (status == ZL303XX_OK)
    {
        ...
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_FAST_LOCK_CTRL_REG, regVal);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
    ...
    return status;
}  /* END zl303xx_Ref77xDpllFastLockMasterEnableSet */

/**
   Function Name:
    zl303xx_Ref77xDpllFastLockFreqErrorThresholdSet
...
zlStatusE zl303xx_Ref77xDpllFastLockFreqErrorThresholdSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIdE dpllId, Uint32T val)
{
    zlStatusE status = ZL303XX_OK;
    zlStatusE multistepMutexStatus = ZL303XX_ERROR;
    ...
    if (status == ZL303XX_OK)
    {
        ...
        status = zl303xx_Write(zl303xx_Params, NULL, ZLS3077X_DPLLX_FAST_LOCK_FREQ_ERR_REG, val);
    }
    if (status == ZL303XX_OK)
    {
        status = zl303xx_Dpll77xSetMailboxSemWrite(zl303xx_Params, ZLS3077X_MB_DPLL);
    ...
    return status;
}  /* END zl303xx_Ref77xDpllFastLockFreqErrorThresholdSet */
