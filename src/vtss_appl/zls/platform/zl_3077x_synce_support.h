...
#ifndef _ZL_3077X_SYNCE_SUPPORT_H_
#define _ZL_3077X_SYNCE_SUPPORT_H_
...
#define ZLS3077X_NUM_SYNTHS                  3        /* synth 0-2 */
#define ZLS3077X_GP_SYNTHID                  0        /* General purpose synthesizer */
...
#define ZLS3077X_CHECK_POST_DIV_ID(divId) \
           (((divId) > ZLS3077X_POST_DIV_D) ?  \
            ZL303XX_PARAMETER_INVALID : \
            ZL303XX_OK)

#define ZLS3077X_CHECK_POST_DIV_ID_C_OR_D(divId) \
           (((divId) < ZLS3077X_POST_DIV_C || (divId) > ZLS3077X_POST_DIV_D) ?  \
            ZL303XX_PARAMETER_INVALID : \
            ZL303XX_OK)

#define ZLS3077X_CHECK_OUT_ID(val)   \
            (((unsigned)(val) > 15) ?  \
            ZL303XX_PARAMETER_INVALID : \
            ZL303XX_OK)
...
#define ZLS3077X_CHECK_SYNTH_ID(synthId) \
           (((synthId) >= ZLS3077X_NUM_SYNTHS) \
...
#define ZL303XX_DPLL_REF_PRIORITY_REG(refId)   \
                    ZL303XX_MAKE_MEM_ADDR_77X(0x614 + (refId / 2), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZLS3077X_DPLL_MON_TH_MASK_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_77X(0x00D0 + (dpllId * 2),  ZL303XX_MEM_SIZE_1_BYTE)

#define ZLS3077X_DPLL_MON_TL_MASK_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_77X(0x00D1 + (dpllId * 2),  ZL303XX_MEM_SIZE_1_BYTE)

#define ZLS3077X_DPLL_MON_MASK_LOCKED_MASK      (Uint32T)(0x01)
#define ZLS3077X_DPLL_MON_MASK_LOCKED_SHIFT     (0)

#define ZLS3077X_DPLL_MON_MASK_HOLDOVER_MASK      (Uint32T)(0x01)
#define ZLS3077X_DPLL_MON_MASK_HOLDOVER_SHIFT     (1)
...
#define ZLS3077X_HP_HSDIV_REG(synthId) \
            ZL303XX_MAKE_MEM_ADDR_77X((0x0490 + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_1_BYTE)
#define ZLS3077X_HP_FDIV_BASE_REG(synthId) \
            ZL303XX_MAKE_MEM_ADDR_77X((0x0491 + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_4_BYTE)
#define ZLS3077X_HP_FDIV_NUM_REG(synthId)  \
            ZL303XX_MAKE_MEM_ADDR_77X((0x0495 + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_4_BYTE)
#define ZLS3077X_HP_FDIV_DEV_REG(synthId)  \
            ZL303XX_MAKE_MEM_ADDR_77X((0x0499 + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_4_BYTE)

/* Synth Drive DPLL */
#define ZLS3077X_HP_CTRL_REG(synthId) \
             ZL303XX_MAKE_MEM_ADDR_77X((0x0480 + 48 *(synthId - 1)), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_HP_OUT_ENABLE(synthId) \
            ZL303XX_MAKE_MEM_ADDR_77X((0x4E0), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_HP_OUT_MASTER_ENABLE_0           0
#define ZL303XX_HP_OUT_MASTER_ENABLE_1           1
#define ZL303XX_HP_OUT_MASTER_ENABLE_2           2
#define ZL303XX_HP_OUT_MASTER_ENABLE_3           3
#define ZL303XX_HP_OUT_MASTER_ENABLE_4           4
#define ZL303XX_HP_OUT_MASTER_ENABLE_5           5
#define ZL303XX_HP_OUT_MASTER_ENABLE_6           6
#define ZL303XX_HP_OUT_MASTER_ENABLE_7           7

#define ZL303XX_HP_OUT_MUX                           (Uint32T)(0x4E1)
#define ZL303XX_HP_OUT_MUX_VAL(outId, divider)       (Uint32T)(divider << (2 * (outId/4)))

/* Synth Skew */
#define ZLS3077X_HP_FINE_SHIFT_REG(synthId)  \
               ZL303XX_MAKE_MEM_ADDR_77X((0x04A4 + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_4_BYTE)
...
#define ZL303XX_CHECK_SYNTH_SKEW(val)  \
            ...
            ZL303XX_PARAMETER_INVALID :  \
            ZL303XX_OK)
#define ZLS3077X_HP_FREQ_BASE_REG(synthId) \
               ZL303XX_MAKE_MEM_ADDR_77X((0x0484 + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_4_BYTE)
#define ZLS3077X_HP_FREQ_M_REG(synthId) \
               ZL303XX_MAKE_MEM_ADDR_77X((0x0488 + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_4_BYTE)
#define ZLS3077X_HP_FREQ_N_REG(synthId) \
               ZL303XX_MAKE_MEM_ADDR_77X((0x048C + 48 * (synthId - 1)), ZL303XX_MEM_SIZE_4_BYTE)

/* HP Differential Output Enable */
#define ZLS3077X_HP_OUT_CTRL_REG(outId)  \
               ZL303XX_MAKE_MEM_ADDR_77X(0x0505 + ((outId/2) * 16), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_CHECK_HP_OUT_FORMAT(val)  \
            ...
            ZL303XX_PARAMETER_INVALID :  \
            ZL303XX_OK)
#define ZLS3077X_HP_OUT_MSDIV_REG(outId)  \
             ZL303XX_MAKE_MEM_ADDR_77X(0x0500 +((outId/2) * 16), ZL303XX_MEM_SIZE_1_BYTE)
#define ZLS3077X_HP_OUT_LSDIV_REG(outId)  \
             ZL303XX_MAKE_MEM_ADDR_77X(0x0501 +((outId/2) * 16), ZL303XX_MEM_SIZE_4_BYTE)
#define ZLS3077X_HP_OUT_LSCTRL_REG(outId)  \
             ZL303XX_MAKE_MEM_ADDR_77X(0x0508 +((outId/2) * 16), ZL303XX_MEM_SIZE_1_BYTE)

#define ZLS3077X_HP_OUT_LSCTRL_NEGLSD_MASK      (Uint32T)(0x20)
#define ZLS3077X_HP_OUT_LSCTRL_NEGLSD_SHIFT     (Uint32T)(5)
#define ZLS3077X_HP_OUT_LSCTRL_LSSEL_MASK       (Uint32T)(0x10)
#define ZLS3077X_HP_OUT_LSCTRL_LSSEL_SHIFT      (Uint32T)(4)
...
#define ZLS3077X_REF_IRQ_ACTIVE_REG(refId) \
             ZL303XX_MAKE_MEM_ADDR_77X(0x1A8 + (refId / 8),  ZL303XX_MEM_SIZE_1_BYTE)
#define ZLS3077X_REF_IRQ_ACTIVE_MASK          (Uint32T)(0x01)
#define ZLS3077X_REF_IRQ_ACTIVE_SHIFT(refId)  (refId % 8)

/* Reference Failure Interrupt config Register */

#define  ZLS3077X_REF_IRQ_MASK_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_77X(0x0A8 + (refId / 8),  ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZLS3077X_REF_MON_TH_MASK_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_77X(0x0B0 + (refId * 2),  ZL303XX_MEM_SIZE_1_BYTE)

#define ZLS3077X_REF_MON_TL_MASK_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_77X(0x0B1 + (refId * 2),  ZL303XX_MEM_SIZE_1_BYTE)
...
/* DPLL ISR Status */
#define ZLS3077X_DPLL_ID_IRQ_ACTIVE_MASK          (Uint32T)(0x01)
#define ZLS3077X_DPLL_ID_IRQ_ACTIVE_SHIFT(dpllId) (dpllId)

/* DPLL Monitor failure Indicators */
#define ZLS3077X_DPLL_MON_STATUS_REG(dpllId) \
             ZL303XX_MAKE_MEM_ADDR_77X(0x0118 + (dpllId) , ZL303XX_MEM_SIZE_1_BYTE)

#define ZLS3077X_DPLL_MON_STICKY_HOLDOVER_MASK              (Uint32T)(0x01)
#define ZLS3077X_DPLL_MON_STICKY_HOLDOVER_SHIFT             (Uint32T)(0x01)
#define ZLS3077X_DPLL_MON_STICKY_LOCKED_MASK                (Uint32T)(0x01)
#define ZLS3077X_DPLL_MON_STICKY_LOCKED_SHIFT               (Uint32T)(0)
...
#define ZLS3077X_REF_MON_STATUS_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_77X(0x0108 + refId ,  ZL303XX_MEM_SIZE_1_BYTE)

/* DPLL Hold Lock Status */

#define ZL303XX_DPLL_HOLD_LOCK_STATUS_REG \
            ZL303XX_MAKE_MEM_ADDR_77X(0x180,  ZL303XX_MEM_SIZE_1_BYTE)
...
zlStatusE zl303xx_Ref77xPhaseMemoryLimitSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIdE refId, Uint32T val);
zlStatusE zl3077x_RefIsrConfigGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIsrConfigS *par);
zlStatusE zl3077x_RefIsrConfigSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIsrConfigS *par);
zlStatusE zl3077x_RefIsrStatusGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIsrStatusS *par);

zlStatusE zl303xx_Ref77xDpllIsrStatusGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllStatusS *par);
zlStatusE zl303xx_Ref77xDpllIsrMaskGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIsrConfigS *par);
zlStatusE zl303xx_Ref77xDpllIsrMaskSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIsrConfigS *par);
...
#endif // _ZL_3077X_SYNCE_SUPPORT_H_
