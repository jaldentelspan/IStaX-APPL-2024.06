...
#ifndef _ZL_3073x_SYNCE_CLOCK_API_H_
#define _ZL_3073x_SYNCE_CLOCK_API_H_
...
mesa_rc zl_3073x_clock_selector_state_get(vtss_appl_synce_selector_state_t *const selector_state, uint *const clock_input);

mesa_rc zl_3073x_clock_priority_set(const uint clock_input, const uint priority);
...
mesa_rc zl_3073x_ref_input_freq_set(const uint32_t refId, const u32 freq_khz);
