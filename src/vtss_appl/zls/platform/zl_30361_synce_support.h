...
#ifndef _ZL_30361_SYNCE_SUPPORT_H_
#define _ZL_30361_SYNCE_SUPPORT_H_
...
//#define ZL303XX_REF_ID_MAX       ZL303XX_REF_ID_10
...
#define ZLS3036X_CHECK_POST_DIV_ID(divId) \
           (((divId) > ZLS3036X_POST_DIV_D) ?  \
            ZL303XX_PARAMETER_INVALID : \
            ZL303XX_OK)

#define ZLS3036X_CHECK_POST_DIV_ID_C_OR_D(divId) \
           (((divId) < ZLS3036X_POST_DIV_C || (divId) > ZLS3036X_POST_DIV_D) ?  \
            ZL303XX_PARAMETER_INVALID : \
            ZL303XX_OK)

#define ZLS3036X_CHECK_OUT_ID(val)   \
            (((unsigned)(val) > 7) ?  \
            ZL303XX_PARAMETER_INVALID : \
            ZL303XX_OK)
...
#define ZL303XX_DPLL_REF_PRIORITY_REG(dpllId,refId)   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x105 + (dpllId * 0x20) + (refId / 2), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_REF_DIVIDE0_REG   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x7C, ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_DIVIDE1_REG   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x7D, ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_DIVIDE_REG(refId)   \
                    (Uint32T)((refId < ZL303XX_REF_ID_8) ? \
                              (ZL303XX_REF_DIVIDE0_REG) : \
                              (ZL303XX_REF_DIVIDE1_REG))

/* Divide Bitfield Masks & Shift Definitions */
#define ZL303XX_REF_DIVIDE_MASK                     (Uint32T)(0x01)
#define ZL303XX_REF_DIVIDE_SHIFT                    (refId % 8)


/* Reference Config Register (Differential Inputs) and Bitfield Attribute Definitions */
#define ZL303XX_REF_DIFF_INPUT0_REG   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x7A, ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_DIFF_INPUT1_REG   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x7B, ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_DIFF_INPUT_REG(refId)   \
                    (Uint32T)((refId < ZL303XX_REF_ID_8) ? \
                              (ZL303XX_REF_DIFF_INPUT0_REG) : \
                              (ZL303XX_REF_DIFF_INPUT1_REG))

/* Reference Config Register (Differential Inputs) Masks & Shift Definitions */
#define ZL303XX_REF_DIFF_INPUT_MASK                     (Uint32T)(0x01)
#define ZL303XX_REF_DIFF_INPUT_SHIFT                    (refId % 8)


/* Phase Acquisition Register and Bitfield Attribute Definitions */
#define ZL303XX_REF_PHASE_ACQUISITION0_REG   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x68, ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_PHASE_ACQUISITION1_REG   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x69, ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_PHASE_ACQUISITION_REG(refId)   \
                    (Uint32T)((refId < ZL303XX_REF_ID_8) ? \
                              (ZL303XX_REF_PHASE_ACQUISITION0_REG) : \
                              (ZL303XX_REF_PHASE_ACQUISITION1_REG))

/* Phase Acquisition Bitfield Masks & Shift Definitions */
#define ZL303XX_REF_PHASE_ACQUISITION_MASK                     (Uint32T)(0x01)
#define ZL303XX_REF_PHASE_ACQUISITION_SHIFT                    (refId % 8)


/* Ref Guard Soak Timer Disqualify Time Register and Bitfield Attribute Definitions */
#define ZL303XX_DPLL_REF_GST_DISQUALIFY_TIME_REG(refId) \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x46 + (refId / 4), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_REF_GST_DISQUALIFY_TIME_MASK               (Uint32T)(0x03)
#define ZL303XX_DPLL_REF_GST_DISQUALIFY_TIME_SHIFT(refId)       ((refId % 4) * 2)
...
#define ZL303XX_DPLL_REF_GST_QUALIFY_TIME_REG(refId) \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x4A + (refId / 4), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_REF_GST_QUALIFY_TIME_MASK               (Uint32T)(0x03)
#define ZL303XX_DPLL_REF_GST_QUALIFY_TIME_SHIFT(refId)       ((refId % 4) * 2)
...
#define ZL303XX_REF_PFM_LIMIT_REG(refId) \
                    ZL303XX_MAKE_MEM_ADDR_36X(0x60 + (refId / 2), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_REF_PFM_LIMIT_MASK               (Uint32T)(0x07)
#define ZL303XX_REF_PFM_LIMIT_SHIFT(refId)       ((refId % 2) * 4)
...
/* Ref Frame Sync Edge */
#define ZL303XX_REF_FRAME_SYNC_EDGE_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0xD8 + refId), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_REF_SYNC_PULSE_INPUT_REG(refId)   \
                    ZL303XX_MAKE_MEM_ADDR_36X(0xEC + (refId / 2), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_REF_SYNC_PULSE_INPUT_MASK               (Uint32T)(0x04)
#define ZL303XX_REF_SYNC_PULSE_INPUT_SHIFT(refId)       ((refId % 2) * 4)
...
/* DPLL Lock Delay */
#define ZL303XX_DPLL_LOCK_DELAY_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x2DC + dpllId), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_DPLL_HITLESS_SWITCHING_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x100 + 0x20*dpllId), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_HITLESS_SWITCHING_MASK                (Uint32T)(0x01)
#define ZL303XX_DPLL_HITLESS_SWITCHING_SHIFT               4

#define ZL303XX_DPLL_HITLESS_SWITCHING_MAX   ZL303XX_DPLL_HITLESS_SWITCHING_MASK

/* DPLL ISR Mask */
#define ZL303XX_DPLL_ISR_MASK_REG \
            ZL303XX_MAKE_MEM_ADDR_36X(0x25, ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_ISR_MASK_LOST_LOCK_MASK              (Uint32T)(0x01)
#define ZL303XX_DPLL_ISR_MASK_LOST_LOCK_SHIFT(dpllId)     (dpllId * 2 + 1)

#define ZL303XX_DPLL_ISR_MASK_HOLDOVER_MASK               (Uint32T)(0x01)
#define ZL303XX_DPLL_ISR_MASK_HOLDOVER_SHIFT(dpllId)      (dpllId * 2)

/* DPLL Ref Fail Mask */
#define ZL303XX_DPLL_REF_FAIL_MASK_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x10D + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_REF_FAIL_MASK_MASK                (Uint32T)(0xFF)
#define ZL303XX_DPLL_REF_FAIL_MASK_SHIFT               0

#define ZL303XX_DPLL_REF_FAIL_MASK_MAX   ZL303XX_DPLL_REF_FAIL_MASK_MASK

#define ZL303XX_CHECK_DPLL_REF_FAIL_MASK(val)  \
            ((val > ZL303XX_DPLL_REF_FAIL_MASK_MAX) ?  \
            ZL303XX_PARAMETER_INVALID :  \
            ZL303XX_OK)

/* DPLL PFM Fail Mask */
#define ZL303XX_DPLL_PFM_FAIL_MASK_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x10D + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_PFM_FAIL_MASK_MASK                (Uint32T)(0xFF)
#define ZL303XX_DPLL_PFM_FAIL_MASK_SHIFT               0

#define ZL303XX_CHECK_DPLL_PFM_FAIL_MASK(val)  \
            ((val != (val & ZL303XX_DPLL_PFM_FAIL_MASK_MASK)) ?  \
            ZL303XX_PARAMETER_INVALID :  \
            ZL303XX_OK)

/* DPLL Phase Slope Limit */
#define ZL303XX_DPLL_PHASE_SLOPE_LIMIT_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x100 + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_PHASE_SLOPE_LIMIT_MASK                (Uint32T)(0x03)
#define ZL303XX_DPLL_PHASE_SLOPE_LIMIT_SHIFT               2
...
/* DPLL Pull-In Range */
#define ZL303XX_DPLL_PULL_IN_RANGE_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x102 + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_PULL_IN_RANGE_MASK                (Uint32T)(0x07)
...
#define ZL303XX_DPLL_HOLDOVER_DELAY_STORAGE_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x10F + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_HOLDOVER_DELAY_STORAGE_MASK                (Uint32T)(0x1F)
...
#define ZL303XX_DPLL_HOLDOVER_FILTER_BANDWIDTH_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x2D4 + dpllId), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_DPLL_REFERENCE_EDGE_SELECT_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x10F + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_DPLL_LOOP_FILTER_CORNER_FREQ_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x100 + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_LOOP_FILTER_CORNER_FREQ_MASK                (Uint32T)(0x07)
#define ZL303XX_DPLL_LOOP_FILTER_CORNER_FREQ_SHIFT               5
...
#define ZL303XX_DPLL_VARIABLE_LOW_BANDWIDTH_SELECT_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x101 + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_DPLL_FAST_LOCK_MASTER_ENABLE_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x2C2 + dpllId * 3), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_DPLL_FAST_LOCK_FORCE_ENABLE_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x2C2 + dpllId * 3), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_DPLL_FAST_LOCK_PHASE_ERROR_THRESHOLD_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x2C3 + dpllId * 3), ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_DPLL_FAST_LOCK_FREQ_ERROR_THRESHOLD_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x2C4 + dpllId * 3), ZL303XX_MEM_SIZE_1_BYTE)
...
/* DPLL PBO Time Out */
#define ZL303XX_DPLL_PBO_TIME_OUT_REG(dpllId) \
            ZL303XX_MAKE_MEM_ADDR_36X((0x114 + dpllId * 0x20), ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_DPLL_PBO_TIME_OUT_MASK                (Uint32T)(0xFF)
#define ZL303XX_DPLL_PBO_TIME_OUT_SHIFT               0

#define ZL303XX_CHECK_DPLL_PBO_TIME_OUT(val)  \
            ((val > ZL303XX_DPLL_PBO_TIME_OUT_MASK) ?  \
            ZL303XX_PARAMETER_INVALID :  \
            ZL303XX_OK)
...
/* Synth Drive DPLL */
#define ZL303XX_SYNTH_DRIVE_PLL_REG \
            ZL303XX_MAKE_MEM_ADDR_36X(0x1B0, ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_SYNTH_DRIVE_PLL_MASK                (Uint32T)(0x03)
#define ZL303XX_SYNTH_DRIVE_PLL_SHIFT(synthId)      (synthId * 2)

/* Synth Skew */
#define ZL303XX_SYNTH_SKEW_REG(synthId) \
            ZL303XX_MAKE_MEM_ADDR_36X(0x250 + synthId, ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_REF_FAIL_ISR_STATUS_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_36X(0x020 + (refId / 8),  ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_FAIL_ISR_STATUS_MASK          (Uint32T)(0x01)
#define ZL303XX_REF_FAIL_ISR_STATUS_SHIFT(refId)  (refId % 8)

/* Reference Failure Interrupt Status Register */

#define ZL303XX_REF_FAIL_ISR_MASK_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_36X(0x023 + (refId / 8),  ZL303XX_MEM_SIZE_1_BYTE)
#define ZL303XX_REF_FAIL_ISR_MASK_MASK          (Uint32T)(0x01)
#define ZL303XX_REF_FAIL_ISR_MASK_SHIFT(refId)  (refId % 8)

/* Reference Monitor Failure Indicators */

#define ZL303XX_REF_MON_FAIL_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_36X(0x026 + refId,  ZL303XX_MEM_SIZE_1_BYTE)

#define ZL303XX_REF_MON_FAIL_LOS_MASK          (Uint32T)(0x01)
#define ZL303XX_REF_MON_FAIL_LOS_SHIFT         0

#define ZL303XX_REF_MON_FAIL_SCM_MASK          (Uint32T)(0x01)
#define ZL303XX_REF_MON_FAIL_SCM_SHIFT         1

#define ZL303XX_REF_MON_FAIL_CFM_MASK          (Uint32T)(0x01)
#define ZL303XX_REF_MON_FAIL_CFM_SHIFT         2

#define ZL303XX_REF_MON_FAIL_GST_MASK          (Uint32T)(0x01)
#define ZL303XX_REF_MON_FAIL_GST_SHIFT         3

#define ZL303XX_REF_MON_FAIL_PFM_MASK          (Uint32T)(0x01)
#define ZL303XX_REF_MON_FAIL_PFM_SHIFT         4

/* DPLL ISR Status */

#define ZL303XX_DPLL_ISR_STATUS_REG \
            ZL303XX_MAKE_MEM_ADDR_36X(0x022,  ZL303XX_MEM_SIZE_1_BYTE)
...
#define ZL303XX_REF_MON_FAIL_MASK_REG(refId) \
            ZL303XX_MAKE_MEM_ADDR_36X(0x036 + refId,  ZL303XX_MEM_SIZE_1_BYTE)

/* DPLL Hold Lock Status */

#define ZL303XX_DPLL_HOLD_LOCK_STATUS_REG \
            ZL303XX_MAKE_MEM_ADDR_36X(0x180,  ZL303XX_MEM_SIZE_1_BYTE)
...
zlStatusE zl30361_SynthEnableSet(zl303xx_ParamsS *zl303xx_Params, Uint32T synthId, zl303xx_BooleanE val);
...
zlStatusE zl30361_RefIsrStatusGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIsrStatusS *par);
zlStatusE zl30361_RefIsrConfigGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIsrConfigS *par);
zlStatusE zl30361_RefIsrConfigSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_RefIsrConfigS *par);

zlStatusE zl303xx_DpllIsrMaskGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIsrConfigS *par);
zlStatusE zl303xx_DpllIsrMaskSet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllIsrConfigS *par);

zlStatusE zl303xx_DpllHoldLockStatusGet(zl303xx_ParamsS *zl303xx_Params, zl303xx_DpllStatusS *par);
...
#endif // _ZL_30361_SYNCE_SUPPORT_H_
