...
#ifndef _ZL_30341_API_H_
#define _ZL_30341_API_H_
...
#define ZL_3034X_DATA_LOCK()   critd_enter(&zl3034x_global.datamutex, __FILE__, __LINE__)
#define ZL_3034X_DATA_UNLOCK() critd_exit (&zl3034x_global.datamutex, __FILE__, __LINE__)

#define ZL_3034X_RC(expr) { mesa_rc _rc_ = (expr); if (_rc_ < VTSS_RC_OK) { \
