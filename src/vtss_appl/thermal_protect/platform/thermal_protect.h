...
typedef struct {
    ...
    vtss_appl_thermal_protect_glbl_conf_t      glbl_conf;
    ...
    vtss_appl_thermal_protect_local_conf_t local_conf[VTSS_ISID_END];
...
typedef struct {
    ...
    vtss_appl_thermal_protect_switch_conf_t         switch_conf;   /* Configuration that for a single switch*/
} thermal_protect_msg_local_switch_conf_t;

// Message for status
typedef struct {
    thermal_protect_msg_id_t                  msg_id;        /* Message ID: */
    vtss_appl_thermal_protect_local_status_t        status;        // Status
} thermal_protect_msg_local_switch_status_t;

// Message for port shutdown
typedef struct {
    thermal_protect_msg_id_t              msg_id;        /* Message ID: */
    mesa_port_no_t                        port_index;    /* Port to shut down*/
...
#define msg_size  MAX(sizeof(thermal_protect_msg_local_switch_conf_t), sizeof(thermal_protect_msg_local_switch_status_t))
