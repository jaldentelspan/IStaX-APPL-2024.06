...
#ifndef __VTSS_APPL_JSON_RPC_NOTIFICATION_ICLI_PRIV_H__
#define __VTSS_APPL_JSON_RPC_NOTIFICATION_ICLI_PRIV_H__
...
mesa_rc JSON_RPC_icli_event_host_auth_basic_del(const char *name);
mesa_rc JSON_RPC_icli_event_host_auth_basic_set(const char *name,
                                                const char *username,
                                                const char *password);
...
#endif  // __VTSS_APPL_JSON_RPC_NOTIFICATION_ICLI_PRIV_H__
