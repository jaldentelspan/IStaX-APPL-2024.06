...
/******************************************************************************/
/* This enum should be clone of mesa_trace_level_t enum */
typedef enum {
...
/******************************************************************************/
typedef vtss_appl_eth_link_oam_control_t vtss_eth_link_oam_control_t;

/******************************************************************************/
/* OAM Mode; Section 30.3.6.1.3                                               */
/******************************************************************************/
typedef vtss_appl_eth_link_oam_mode_t    vtss_eth_link_oam_mode_t;
...
typedef enum eth_link_oam_capability_conf {
    ...
    VTSS_ETH_LINK_OAM_CONF_VARIABLE_RETRIEVAL_SUPPORT = 0x10,
...
typedef vtss_appl_eth_link_oam_statistics_t                 vtss_eth_link_oam_pdu_stats_t;

/* The following are non-standard stats for critical events.
   So keeping them in different data structures     */
typedef vtss_appl_eth_link_oam_crit_link_event_statistics_t vtss_eth_link_oam_critical_event_pdu_stats_t;
...
/* port_no:         port number                                               */
/* oam_control:     port's OAM control configuration                          */
/* Retrieves the port's OAM Control flag of the port                          */
...
mesa_rc vtss_eth_link_oam_control_port_mux_parser_conf_set(const u32 port_no, const vtss_eth_link_oam_mux_state_t  mux_state, const vtss_eth_link_oam_parser_state_t parser_state, u32 *oam_ace_id, u32 *lb_ace_id, const BOOL update_mux_state_only);
/* port_no:         port number                                               */
...
/* Retrieves the support configuration for the specified oam code             */
...
/* retrieves the PDU control of the port                                      */
