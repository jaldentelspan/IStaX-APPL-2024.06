...
typedef struct eth_link_oam_control_oper_conf {
    CapArray<vtss_eth_link_oam_control_port_conf_t, MEBA_CAP_BOARD_PORT_MAP_COUNT> port_conf;
    CapArray<u8, MEBA_CAP_BOARD_PORT_MAP_COUNT> oam_supported_codes;
...
/* retrieves the discovery protocol state                                     */
...
/* Retrieves the port's OAM stats                                             */
u32 vtss_eth_link_oam_control_layer_port_pdu_stats_get(const u32 port_no, vtss_eth_link_oam_pdu_stats_t *const port_stats);

/* port_no:         port number                                               */
/* Increments dying gasp pdu tx counter                                       */
void vtss_eth_link_oam_control_increment_dying_gasp_pdu_tx(const u32 port_no);
