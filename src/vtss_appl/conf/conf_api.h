...
/*
   ...
   1. Determine the configuration section to use. You will most likely
      use the GLOBAL section, which contains data replicated to secondary
   ...
   5. Implement the C code accessing the data:
      - On INIT_CMD_ICFG_LOADING_PRE events, read the configuration data using
...
/* Board Config, TAG style */
mesa_rc conf_mgmt_board_tag_set(const char *name, const char *value);
...
//  VTSS_ENUM_INC(conf_sec_t); in the bottom
...
typedef enum {
    ...
    CONF_BLK_POE_CONF,
    CONF_BLK_EPS_CONF_TABLE_UNUSED,
    CONF_BLK_MEP_CONF_TABLE_UNUSED,
    CONF_BLK_HTTPS_CONF,
    CONF_BLK_AUTH_TABLE,
    CONF_BLK_SSH_CONF,
    ...
    CONF_BLK_EVC_POL_CONF_UNUSED,
    CONF_BLK_EVC_ECE_CONF_UNUSED,
    CONF_BLK_UNUSED_CONF,
    CONF_BLK_SYSLOG_CONF,
    CONF_BLK_VLAN_TRANS_VLAN_TABLE,
    CONF_BLK_VLAN_TRANS_PORT_TABLE,
    CONF_BLK_CE_MAX_UNUSED_CONF,
    ...
    CONF_BLK_DAYLIGHT_SAVING, /* 100 */
    CONF_BLK_PHY_CONF,
    CONF_BLK_TOD_CONF,
    CONF_BLK_EVC_GLOBAL_CONF_UNUSED,
    CONF_BLK_DEPRECATED_MCSNP6_CONF,
    CONF_BLK_OS_FILE_CONF,
    CONF_BLK_ICLI,
    CONF_BLK_TRAP_CONF,
    CONF_BLK_SNTP_CONF,
    CONF_BLK_RFC2544_PROFILES_UNUSED,
    CONF_BLK_MSG, /* 110 */
    CONF_BLK_RFC2544_REPORTS_UNUSED,
    CONF_BLK_GARP_CONF_TABLE,
    CONF_BLK_GVRP_CONF_TABLE,
    CONF_BLK_PM_LM_REPORTS_UNUSED,
    CONF_BLK_PM_DM_REPORTS_UNUSED,
    CONF_BLK_PM_EVC_REPORTS_UNUSED,
    CONF_BLK_PM_ECE_REPORTS_UNUSED,
    CONF_BLK_POST_CONF,
    CONF_BLK_RMIRROR_CONF,
    CONF_BLK_FIRMWARE_CONF, /* 120 */
    CONF_BLK_FIRMWARE_STATE,
    CONF_BLK_PM_DM_BIN_REPORTS_UNUSED,
    CONF_BLK_Y1564_PROFILES_UNUSED,
    CONF_BLK_Y1564_REPORTS_UNUSED,
    CONF_BLK_BOARD_PORT_CFG,
    CONF_BLK_QUEUE_CONF,
...
static const char *conf_blk_name[] = {
    ...
    /*[CONF_BLK_EPS_CONF_TABLE_UNUSED]    = */"EPS",
    /*[CONF_BLK_MEP_CONF_TABLE_UNUSED]    = */"MEP",
    ...
    /*[CONF_BLK_EVC_CONF_UNUSED]          = */"EVC",
    /*[CONF_BLK_EVC_UNI_CONF_UNUSED]      = */"EVC_UNI",
    ...
    /*[CONF_BLK_EVC_PORT_CONF_UNUSED]     = */"EVC_PORT",
    ...
    /*[CONF_BLK_EVC_POL_CONF_UNUSED]      = */"EVC_POL_CONF",
    /*[CONF_BLK_EVC_ECE_CONF_UNUSED]      = */"EVC_ECE_CONF",
    /*[CONF_BLK_UNUSED_CONF]              = */"UNUSED_CONF",
    ...
    /*[CONF_BLK_CE_MAX_UNUSED_CONF]       = */"CE_MAX_UNUSED_CONF",
    ...
    /*[CONF_BLK_EVC_GLOBAL_CONF_UNUSED]   = */"EVC_GLOBAL_CONF",
    ...
    /*[CONF_BLK_RFC2544_PROFILES_UNUSED]  = */"RFC2544_PROFILES",
    /*[CONF_BLK_MSG]                      = */"MSG",
    /*[CONF_BLK_RFC2544_REPORTS_UNUSED]   = */"RFC2544_REPORTS",
    /*CONF_BLK_GARP_CONF_TABLE            = */"",
    /*CONF_BLK_GVRP_CONF_TABLE            = */"",
    /*[CONF_BLK_PM_LM_REPORTS_UNUSED]     = */"PM_LM_REPORTS",
    /*[CONF_BLK_PM_DM_REPORTS_UNUSED]     = */"PM_DM_REPORTS",
    /*[CONF_BLK_PM_EVC_REPORTS_UNUSED]    = */"PM_EVC_REPORTS",
    /*[CONF_BLK_PM_ECE_REPORTS_UNUSED]    = */"PM_ECE_REPORTS",
    /*[CONF_BLK_POST_CONF]                = */"POST",
    /*[CONF_BLK_RMIRROR_CONF]             = */"RMIRROR",
    /*[CONF_BLK_FIRMWARE_CONF]            = */"FIRMWARE_CONF",
    /*[CONF_BLK_FIRMWARE_STATE]           = */"FIRMWARE_STATE",
    /*[CONF_BLK_PM_DM_BIN_REPORTS_UNUSED] = */"PM_DM_BIN_REPORTS",
    /*[CONF_BLK_Y1564_PROFILES_UNUSED]    = */"Y1564_PROFILES",
    /*[CONF_BLK_Y1564_REPORTS_UNUSED]     = */"Y1564_REPORTS",
    /*[CONF_BLK_BOARD_PORT_CFG]           = */"BOARD_PORT_CFG",
    /*[CONF_BLK_QUEUE_CONF]               = */"QUEUE_CONF",
...
mesa_rc conf_mgmt_conf_get(conf_mgmt_conf_t *conf);

/* Set module configuration */
mesa_rc conf_mgmt_conf_set(conf_mgmt_conf_t *conf);
...
#define CONF_BLK_MAX_GLOBAL (2*1024*1024) /* Maximum block size in global section */
...
/* Wait untill configuration saved */
...
/*lint -save -e19 */
VTSS_ENUM_INC(conf_sec_t);
VTSS_ENUM_INC(conf_blk_id_t);
/*lint -restore */
