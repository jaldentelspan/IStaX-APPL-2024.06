...
#if !defined(_SYNCE_DPLL_SERVALT_H)
#define _SYNCE_DPLL_SERVALT_H

#include "synce_dpll_base.h"

struct synce_dpll_servalt : synce_dpll_base {
    void control_selector(void);
    ...
    {
        return VTSS_ZL_30380_DPLL_GENERIC;
    }
};

#endif // _SYNCE_DPLL_SERVALT_H
