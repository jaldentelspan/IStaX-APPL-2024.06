...
#if !defined(_SYNCE_DPLL_ZL3073X_H)
#define _SYNCE_DPLL_ZL3073X_H

#include "synce_dpll_zl303xx.h"

struct synce_dpll_zl3073x : synce_dpll_zl303xx {
    ...
    {
        return VTSS_ZL_30380_DPLL_ZLS3073X;
    }
    virtual mesa_rc clock_nco_assist_set(bool enable);
    virtual mesa_rc fw_ver_get(meba_synce_clock_fw_ver_t *dpll_fw_ver)
    {
        return meba_synce_spi_if_dpll_fw_ver_get(board_instance, dpll_fw_ver);
    }
};

#endif // _SYNCE_DPLL_ZL3073X_H
