...
#define DHCP_SERVER_MESSAGE_OPTION_CODE_RELAY_AGENT             82  /**< Relay Agent option, used to convey information of the root client */
...
/*
    Flag
*/
#define DHCP_SERVER_MESSAGE_FLAG_BROADCAST      0x8000
 ...
 */
enum {
    DHCP_SERVER_MESSAGE_CLIENT_IDENTIFIER_TYPE_NAME,  /**< Client identifier other than hardware type */
