...
#define ICLI_COLON                      ':'
#define ICLI_AT                         '@'
#define ICLI_LSQUARE_BRACKET            '['
#define ICLI_RSQUARE_BRACKET            ']'
