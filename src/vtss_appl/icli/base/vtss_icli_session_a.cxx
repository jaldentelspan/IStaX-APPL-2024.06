...
)
{
    ...
    // go to the end
    icli_platform_cursor_offset(handle, ex - x, ey - y);
}
...
)
{
    ...
    // go back to the original x,y
    icli_platform_cursor_offset(handle, nx - x, ny - y);
...
)
{
    ...
    // go back to the original x,y
    icli_platform_cursor_offset(handle, handle->runtime_data.prompt_len - x, 0 - y);
...
)
{
    ...
    icli_platform_cursor_offset(handle, x - ex, y - ey);
