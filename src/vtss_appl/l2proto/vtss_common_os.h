...
typedef mesa_stp_state_t vtss_common_stpstate_t; /* Port Spanning Tree state */
#define VTSS_COMMON_STPSTATE_DISCARDING ((vtss_common_stpstate_t)MESA_STP_STATE_DISCARDING)
#define VTSS_COMMON_STPSTATE_LEARNING   ((vtss_common_stpstate_t)MESA_STP_STATE_LEARNING)
#define VTSS_COMMON_STPSTATE_FORWARDING ((vtss_common_stpstate_t)MESA_STP_STATE_FORWARDING)
...
static inline void __put_unaligned_2_le(__u32 __v, __u8 *__p)
{
    *__p++ = __v;
    *__p++ = __v >> 8;
}

static inline void __put_unaligned_2_be(__u32 __v, __u8 *__p)
{
    *__p++ = __v >> 8;
    *__p++ = __v;
}

static inline void __put_unaligned_4_le(__u32 __v, __u8 *__p)
{
    __put_unaligned_2_le(__v >> 16, __p + 2);
    __put_unaligned_2_le(__v, __p);
}

static inline void __put_unaligned_4_be(__u32 __v, __u8 *__p)
{
 ...
 */
extern void VTSS_COMMON_BUFMEM_ATTRIB *vtss_os_alloc_xmit(vtss_common_port_t portno, vtss_common_framelen_t len);

/**
 * vtss_os_xmit - Transmit a frame on a specific port.
 */
extern int vtss_os_xmit(vtss_common_port_t portno, void VTSS_COMMON_BUFMEM_ATTRIB *frame, vtss_common_framelen_t len);
