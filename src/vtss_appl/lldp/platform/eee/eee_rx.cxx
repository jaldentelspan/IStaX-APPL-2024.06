...
lldp_bool_t eee_update_necessary(lldp_rx_remote_entry_t *rx_entry, vtss_appl_lldp_remote_entry_t *entry)
{
    ...
    return memcmp(&rx_entry->eee, &entry->eee, sizeof(vtss_appl_lldp_eee_t)) == 0 ? LLDP_FALSE : LLDP_TRUE;
}
...
void eee_update_entry(lldp_rx_remote_entry_t *rx_entry, vtss_appl_lldp_remote_entry_t *entry)
{
