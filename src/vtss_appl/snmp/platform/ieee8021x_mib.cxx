...
vtss_appl_glbl_cfg_t old_global_cfg, current_global_cfg;
vtss_appl_nas_port_cfg_t old_port_conf, current_port_conf;
                   ...
                   WriteMethod **write_method)
{
    ...
    case DOT1XPAESYSTEMAUTHCONTROL: {
        ...
        *write_method = write_dot1xPaeSystemAuthControl;
        ...
        if (vtss_appl_nas_glbl_cfg_get(&current_global_cfg) != VTSS_RC_OK) {
            return NULL;
        }
                         ...
                         WriteMethod **write_method)
{
    ...
    *write_method = NULL;
    ...
    vtss_usid_t usid = topo_isid2usid(table_info.isid);
    ...
    case DOT1XAUTHAUTHCONTROLLEDPORTSTATUS: {
        ...
        if (switch_status.status[table_info.if_id] == VTSS_APPL_NAS_PORT_STATUS_AUTHORIZED) {
            ulong_ret = 1;
        } else {
            ulong_ret = 2;
        }
    ...
    case DOT1XAUTHAUTHCONTROLLEDPORTCONTROL: {
        vtss_nas_switch_cfg_t  switch_conf;
        *write_method = write_dot1xAuthAuthControlledPortControl;

        if (vtss_nas_switch_cfg_get(usid, &switch_conf) != VTSS_RC_OK) {
            return NULL;
        }
        ...
        if (switch_conf.port_cfg[table_info.if_id - VTSS_PORT_NO_START].admin_state == VTSS_APPL_NAS_PORT_CONTROL_FORCE_AUTHORIZED) {
            ulong_ret = 3;
        } else if (switch_conf.port_cfg[table_info.if_id - VTSS_PORT_NO_START].admin_state == VTSS_APPL_NAS_PORT_CONTROL_FORCE_UNAUTHORIZED) {
            ulong_ret = 1;
        } else if (switch_conf.port_cfg[table_info.if_id - VTSS_PORT_NO_START].admin_state == VTSS_APPL_NAS_PORT_CONTROL_AUTO) {
            ulong_ret = 2;
        } else {
            ulong_ret = 0;
        }
                        ...
                        WriteMethod **write_method)
{
    ...
    if (vtss_nas_statistics_get(ifindex, NULL, &stat) != VTSS_RC_OK) {
        return NULL;
    }
                                ...
                                size_t   name_len)
{
    ...
    case ACTION: {
        ...
        if (vtss_appl_nas_glbl_cfg_get(&old_global_cfg) != VTSS_RC_OK) {
        ...
        if (vtss_appl_nas_glbl_cfg_set(&current_global_cfg) != VTSS_RC_OK) {
            return SNMP_ERR_RESOURCEUNAVAILABLE;
        }
    ...
    case UNDO: {
        ...
        if (vtss_appl_nas_glbl_cfg_set(&old_global_cfg) != VTSS_RC_OK) {
            return SNMP_ERR_RESOURCEUNAVAILABLE;
        }
                             ...
                             size_t   name_len)
{
    ...
    case ACTION: {
        if (*var_val == TRUE) {
            if (vtss_nas_reauth(ifindex, 0) != VTSS_RC_OK) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
        }
        break;
                                 ...
                                 size_t   name_len)
{
    ...
    case ACTION: {
        if (*var_val == TRUE) {
            if (vtss_nas_reauth(ifindex, 1) != VTSS_RC_OK) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
        }
                                         ...
                                         size_t   name_len)
{
    ...
    case ACTION: {
        if (vtss_nas_switch_cfg_get(table_info.isid, &switch_conf) != VTSS_RC_OK) {
            return SNMP_ERR_RESOURCEUNAVAILABLE;
        }
        ...
        if (*var_val == 3) {
            current_port_conf.admin_state = VTSS_APPL_NAS_PORT_CONTROL_FORCE_AUTHORIZED;
        } else if (*var_val == 2) {
            current_port_conf.admin_state = VTSS_APPL_NAS_PORT_CONTROL_AUTO;
        } else if (*var_val == 1) {
            current_port_conf.admin_state = VTSS_APPL_NAS_PORT_CONTROL_FORCE_UNAUTHORIZED;
        }
        ...
        if (old_port_conf.admin_state != current_port_conf.admin_state) {
            ...
            if (vtss_nas_switch_cfg_set(usid, &switch_conf) != VTSS_RC_OK) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
        }
