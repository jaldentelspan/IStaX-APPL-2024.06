...
ucd_snmp_init_mib2_interfaces(void)
{
    ...
    if (!interfaces_register_flag) {
        ...
        port_change_register(VTSS_MODULE_ID_SNMP, interfaces_port_state_change_callback);
            ...
            int exact, size_t *var_len, WriteMethod **write_method)
{
    ...
    int             idx_num;
    static u_long   ulong_ret;
    static char     string[IFDESCR_MAX_LEN + 1]; // In order to guarantuee that the memory doesn't overflow, the size is equal to IFDESCR string size.
    static oid      objid[MAX_OID_LEN];
    ...
    case IFDESCR: {
        strcpy(string, (const char *)table_entry.ifDescr);
        ...
        int exact, size_t *var_len, WriteMethod **write_method)
{
    ...
    os_wrapper_tcp_stat_get(&tcpstat);
    /*
     * this is where we do the value assignments for the mib results.
     */
    switch (vp->magic) {
    case TCPATTEMPTFAILS: {
        long_ret = tcpstat.tcpAttemptFails;
        return (u_char *) &long_ret;
    }
    case TCPRTOMAX: {
        long_ret = tcpstat.tcpRtoMax;
        return (u_char *) &long_ret;
    }
    case TCPACTIVEOPENS: {
        long_ret = tcpstat.tcpActiveOpens;
        return (u_char *) &long_ret;
    }
    case TCPINSEGS: {
        long_ret = tcpstat.tcpInSegs;
        return (u_char *) &long_ret;
    }
    case TCPOUTSEGS: {
        long_ret = tcpstat.tcpOutSegs;
        if (long_ret < 0) {
            long_ret = 0;
        }
        return (u_char *) &long_ret;
    ...
    case TCPINERRS: {
        long_ret = tcpstat.tcpInErrs;
        return (u_char *) &long_ret;
    }
    case TCPMAXCONN: {
        long_ret = tcpstat.tcpMaxConn; /* It is dynamic */
        return (u_char *) &long_ret;
    }
    case TCPPASSIVEOPENS: {
        long_ret = tcpstat.tcpPassiveOpens;
        return (u_char *) &long_ret;
    }
    case TCPOUTRSTS: {
        long_ret = tcpstat.tcpOutRsts;
        if (long_ret < 0) {
            long_ret = 0;
        }
        return (u_char *) &long_ret;
    ...
    case TCPRTOMIN: {
        long_ret = tcpstat.tcpRtoMin;
        return (u_char *) &long_ret;
    }
    case TCPRTOALGORITHM: {
        long_ret = tcpstat.tcpRtoAlgorithm; /* meaning "other" */
        return (u_char *) &long_ret;
    }
    case TCPCURRESTAB: {
        long_ret = tcpstat.tcpCurrEstab;
        return (u_char *) &long_ret;
    }
    case TCPESTABRESETS: {
        long_ret = tcpstat.tcpEstabResets;
        return (u_char *) &long_ret;
    }
    case TCPRETRANSSEGS: {
        long_ret = tcpstat.tcpRetransSegs;
        return (u_char *) &long_ret;
    }
    default:
                 ...
                 int exact, size_t *var_len, WriteMethod **write_method)
{
    ...
    oid                   *op;
    void                  *pre = NULL;
    tcp_connTable_entry_t entry, low_entry;
    BOOL                    found = FALSE;
    ...
    memset(&low_entry, 0, sizeof(low_entry));

    T_D("enter");
    while(!os_wrapper_tcp_conn_entry_iterator(&pre, &entry))
    {
        cp = entry.tcpConnectionLocalAddress;
        op = newname + 10;
        *op++ = *cp++;
        *op++ = *cp++;
        *op++ = *cp++;
        *op++ = *cp++;
        ...
        newname[14] = entry.tcpConnectionLocalPort;

        cp = entry.tcpConnectionRemAddress;
        op = newname + 15;
        *op++ = *cp++;
        *op++ = *cp++;
        *op++ = *cp++;
        *op++ = *cp++;
        ...
        newname[19] = entry.tcpConnectionRemPort;
        ...
        if (exact) {
            ...
            if ((snmp_oid_compare(newname, 20, name, *length) > 0) &&
                (!found || (snmp_oid_compare(newname, 20, lowest, 20) < 0))) {
                /*
    ...
    *write_method = 0;
    ...
    case TCPCONNSTATE: {
        ...
        *write_method = write_tcpConnState; */
        ulong_ret = low_entry.tcpConnectionState;
        return (u_char *) &ulong_ret;
    }
    case TCPCONNLOCALADDRESS: {
        cp = low_entry.tcpConnectionLocalAddress;
        string[0] = *cp++;
        string[1] = *cp++;
        string[2] = *cp++;
        string[3] = *cp++;
    ...
    case TCPCONNLOCALPORT: {
        ulong_ret = low_entry.tcpConnectionLocalPort;
        return (u_char *) &ulong_ret;
    }
    case TCPCONNREMADDRESS: {
        cp = low_entry.tcpConnectionRemAddress;
        string[0] = *cp++;
        string[1] = *cp++;
        string[2] = *cp++;
        string[3] = *cp++;
        ...
        int exact, size_t *var_len, WriteMethod **write_method)
{
    ...
    os_wrapper_udp_stat_get(&udpstat);
    /*
     * this is where we do the value assignments for the mib results.
     */
    switch (vp->magic) {
    case UDPINERRORS: {
        ulong_ret = udpstat.udpInErrors;
        return (u_char *) &ulong_ret;
    }
    case UDPNOPORTS: {
        ulong_ret = udpstat.udpNoPorts;
        return (u_char *) &ulong_ret;
    }
    case UDPOUTDATAGRAMS: {
        ulong_ret = udpstat.udpOutDatagrams;
        return (u_char *) &ulong_ret;
    }
    case UDPINDATAGRAMS: {
        ulong_ret = udpstat.udpInDatagrams;
        return (u_char *) &ulong_ret;
    }
    default:
...
//    register struct inpcb *inp;
    ...
    oid                    *op;
    void                  *pre = NULL;
    udp_connTable_entry_t entry, low_entry;
    BOOL                    found = FALSE;
    ...
    while (!os_wrapper_udp_conn_entry_iterator(&pre, &entry)) {
        cp = entry.udpConnectionLocalAddress;
        op = newname + 10;
        *op++ = *cp++;
        *op++ = *cp++;
        *op++ = *cp++;
        *op++ = *cp++;
        ...
        newname[14] = entry.udpConnectionLocalPort;
        ...
        if (exact) {
            ...
            if ((snmp_oid_compare(newname, 15, name, *length) > 0) &&
                (!found || (snmp_oid_compare(newname, 15, lowest, 15) < 0))) {
                /*
                 * if new one is greater than input and closer to input than
                 * previous lowest, save this one as the "next" one.
                 */
    ...
    *write_method = 0;
    ...
    case UDPLOCALADDRESS: {
        cp = low_entry.udpConnectionLocalAddress;
        string[0] = *cp++;
        string[1] = *cp++;
        string[2] = *cp++;
        string[3] = *cp++;
    ...
    case UDPLOCALPORT: {
        ulong_ret = low_entry.udpConnectionLocalPort;
        return (u_char *) &ulong_ret;
    }
    default:
...
#endif /* the trap confgiuraton is not in here */
                            ...
                            u_char *statP, oid *name, size_t name_len)
{
    ...
    case ACTION: {
        ...
        *buf = *((u_long *) var_val);
        ...
        if (snmp_mgmt_snmp_conf_set(&snmp_conf) != VTSS_RC_OK) {
