                      ...
                      size_t *var_len, WriteMethod ** write_method)
{
    ...
    *write_method = NULL;
    ...
    if ((rc =
        ...
        if (skip_invalid_row) {
            while (table_entry.ieee8021MstpRowStatus != 1) {
                if (ieee8021MstpTableEntry_get(&table_entry, TRUE)) {
                    return NULL;
                }
            }
        }
        ...
        do {
            if (skip_invalid_row) {
                if ((exact && (ieee8021MstpTableEntry_get(&table_entry, FALSE) || table_entry.ieee8021MstpRowStatus != 1)) ||
                    (!exact && ieee8021MstpTableEntry_get(&table_entry, TRUE))) {
                    return NULL;
                }
                              ...
                              size_t *var_len, WriteMethod ** write_method)
{
    ...
    *write_method = NULL;
    ...
    T_D("column is %d, %sSKIP status OID", vp->magic, skip_invalid_row ? "" : "DO NOT ");
    ...
    if ((rc =
        ...
        if (skip_invalid_row) {
            T_D("get first row");
            while (!table_entry.active) {
                T_N("get next row from(%lu, %lu", table_entry.ieee8021MstpCistPortComponentId, table_entry.ieee8021MstpCistPortNum);
                if (ieee8021MstpCistPortTableEntry_get(&table_entry, TRUE)) {
                    return NULL;
                }
            }
            T_D("first row is in (%lu, %lu)", table_entry.ieee8021MstpCistPortComponentId, table_entry.ieee8021MstpCistPortNum);
        }
        ...
        do {
            if (skip_invalid_row) {
                if ((exact && (ieee8021MstpCistPortTableEntry_get(&table_entry, FALSE) || !table_entry.active)) ||
                    (!exact && ieee8021MstpCistPortTableEntry_get(&table_entry, TRUE))) {
                    return NULL;
                }
                ...
                if (!exact) {
                    ...
                    T_D("next row is in (%lu, %lu)", table_entry.ieee8021MstpCistPortComponentId, table_entry.ieee8021MstpCistPortNum);
                }
            } else {
                          ...
                          size_t *var_len, WriteMethod ** write_method)
{
    ...
    *write_method = NULL;
    ...
    if ((rc =
        ...
        if (skip_invalid_row) {
            while (!table_entry.active) {
                if (ieee8021MstpPortTableEntry_get(&table_entry, TRUE)) {
                    return NULL;
                }
            }
        }
        ...
        do {
            if (skip_invalid_row) {
                if ((exact && (ieee8021MstpPortTableEntry_get(&table_entry, FALSE) || !table_entry.active)) ||
                    (!exact && ieee8021MstpPortTableEntry_get(&table_entry, TRUE))) {
                    return NULL;
                }
                              ...
                              u_char * statP, oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            /* The range is from 100 to 4000 according to IEEE8021-MSTP-MIB definition,
               but MSCC change it from 6 to 40 */
            if (set_value < 6 || set_value > 40) {
                return SNMP_ERR_WRONGVALUE;
            }
            break;
        }
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021MstpCistTable_entry_t *)
    ...
    case UNDO:{
            if (old_table_entry_p) {
                int set_rc = ieee8021MstpCistTableEntry_set(old_table_entry_p);
                ucd_snmp_callout_free(old_table_entry_p);
                old_table_entry_p = NULL;
                if (set_rc) {
                                 ...
                                 oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            if (set_value > 61440 || set_value < 0) {
                return SNMP_ERR_WRONGVALUE;
            }
            break;
        }
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021MstpTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
    ...
    case UNDO:{
            if (old_table_entry_p) {
                int set_rc = ieee8021MstpTableEntry_set(old_table_entry_p);
                ucd_snmp_callout_free(old_table_entry_p);
                old_table_entry_p = NULL;
                if (set_rc) {
                    return SNMP_ERR_UNDOFAILED;
                                        ...
                                        oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            /* The range is from 1 to 200000000 according to IEEE8021-MSTP-MIB definition,
               but MSCC' use 0 to indicate the path cost is 'auto' */
            if (set_value > 200000000 || set_value < 0) {
                return SNMP_ERR_WRONGVALUE;
            }
            break;
        }
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021MstpCistPortTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
    ...
    case UNDO:{
            if (old_table_entry_p) {
                int set_rc = ieee8021MstpCistPortTableEntry_set(old_table_entry_p);
                ucd_snmp_callout_free(old_table_entry_p);
                old_table_entry_p = NULL;
                if (set_rc) {
                    return SNMP_ERR_UNDOFAILED;
                               ...
                               u_char * statP, oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            if (set_value > 240 || set_value < 0) {
                return SNMP_ERR_WRONGVALUE;
            }
            break;
        }
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021MstpPortTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
    ...
    case UNDO:{
            if (old_table_entry_p) {
                int set_rc = ieee8021MstpPortTableEntry_set(old_table_entry_p);
                ucd_snmp_callout_free(old_table_entry_p);
                old_table_entry_p = NULL;
                if (set_rc) {
                    return SNMP_ERR_UNDOFAILED;
                               ...
                               u_char * statP, oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            if (set_value < 0 || set_value > 200000000) {
                return SNMP_ERR_WRONGVALUE;
            }
            break;
        }
                                 ...
                                 oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021MstpFidToMstiTable_entry_t*)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
    ...
    case UNDO:{
            if (old_table_entry_p) {
                int set_rc = ieee8021MstpFidToMstiTableEntry_set(old_table_entry_p);
                ucd_snmp_callout_free(old_table_entry_p);
                old_table_entry_p = NULL;
                if (set_rc) {
                    return SNMP_ERR_UNDOFAILED;
                                         ...
                                         oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021MstpConfigIdTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
    ...
    case UNDO:{
            if (old_table_entry_p) {
                int set_rc = ieee8021MstpConfigIdTableEntry_set(old_table_entry_p);
                ucd_snmp_callout_free(old_table_entry_p);
                old_table_entry_p = NULL;
                if (set_rc) {
                    return SNMP_ERR_UNDOFAILED;
