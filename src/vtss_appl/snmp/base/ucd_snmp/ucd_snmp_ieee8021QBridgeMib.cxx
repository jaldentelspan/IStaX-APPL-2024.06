...
#define IEEE8021QBRIDGEMVRPENABLEDSTATUS                6
    {IEEE8021QBRIDGEMVRPENABLEDSTATUS, ASN_INTEGER, RONLY,
     ieee8021QBridgeTable_var, 5, {1, 1, 1, 1, 6}},
...
#define IEEE8021QBRIDGESTATICUNICASTSTATICEGRESSPORTS                21
    {IEEE8021QBRIDGESTATICUNICASTSTATICEGRESSPORTS, ASN_OCTET_STR, RONLY,
...
#define IEEE8021QBRIDGESTATICUNICASTFORBIDDENEGRESSPORTS                22
    {IEEE8021QBRIDGESTATICUNICASTFORBIDDENEGRESSPORTS, ASN_OCTET_STR,
     RONLY, ieee8021QBridgeStaticUnicastTable_var, 5, {1, 3, 1, 1, 6}},
#define IEEE8021QBRIDGESTATICUNICASTSTORAGETYPE                23
    {IEEE8021QBRIDGESTATICUNICASTSTORAGETYPE, ASN_INTEGER, RONLY,
     ieee8021QBridgeStaticUnicastTable_var, 5, {1, 3, 1, 1, 7}},
#endif /* IEEE8021QBRIDGEMIB_NOT_SUPPORTED */
#define IEEE8021QBRIDGESTATICUNICASTROWSTATUS                24
    {IEEE8021QBRIDGESTATICUNICASTROWSTATUS, ASN_INTEGER, RONLY,
...
#define IEEE8021QBRIDGESTATICMULTICASTSTATICEGRESSPORTS                25
    {IEEE8021QBRIDGESTATICMULTICASTSTATICEGRESSPORTS, ASN_OCTET_STR,
     RONLY, ieee8021QBridgeStaticMulticastTable_var, 5, {1, 3, 2, 1, 3}},
#if IEEE8021QBRIDGEMIB_NOT_SUPPORTED
#define IEEE8021QBRIDGESTATICMULTICASTFORBIDDENEGRESSPORTS                26
    {IEEE8021QBRIDGESTATICMULTICASTFORBIDDENEGRESSPORTS, ASN_OCTET_STR,
     RONLY, ieee8021QBridgeStaticMulticastTable_var, 5, {1, 3, 2, 1, 4}},
#define IEEE8021QBRIDGESTATICMULTICASTSTORAGETYPE                27
    {IEEE8021QBRIDGESTATICMULTICASTSTORAGETYPE, ASN_INTEGER, RONLY,
     ieee8021QBridgeStaticMulticastTable_var, 5, {1, 3, 2, 1, 5}},
#endif /* IEEE8021QBRIDGEMIB_NOT_SUPPORTED */
#define IEEE8021QBRIDGESTATICMULTICASTROWSTATUS                28
    {IEEE8021QBRIDGESTATICMULTICASTROWSTATUS, ASN_INTEGER, RONLY,
...
#endif /* IEEE8021QBRIDGEMVRPENABLEDSTATUS */
    default:
        DEBUGMSGTL(("snmpd",
...
ieee8021QBridgeTpFdbTable_parse(oid * name,
                                ...
                                table_entry)
{
    size_t          op_pos = 11 + 2, orig_op_pos;
    oid            *op = (oid *) (name + op_pos);
    u_char         *cp = NULL;
    size_t          len = 0, zero_cnt = 0;
        ...
        if (*length > op_pos) {
            *cp++ = (u_char) * op++;
            ...
            do {
                ...
                *(cp--) = 0xff;
                zero_cnt++;
            } while (cp >= (u_char *)table_entry->ieee8021QBridgeTpFdbAddress);
            if (zero_cnt == (*length - orig_op_pos + 1)) {
                memset(table_entry->ieee8021QBridgeTpFdbAddress, 0, sizeof(table_entry->ieee8021QBridgeTpFdbAddress));
                //return 1;
            }
            return 0;
        }
        ...
        if (*length > op_pos) {
            *cp++ = (u_char) * op++;
            ...
            do {
                ...
                *(cp--) = 0xff;
                zero_cnt++;
            } while (cp >= (u_char *)table_entry->ieee8021QBridgeTpGroupAddress);
            if (zero_cnt == (*length - orig_op_pos + 1)) {
                memset(table_entry->ieee8021QBridgeTpGroupAddress, 0, sizeof(table_entry->ieee8021QBridgeTpGroupAddress));
                //return 1;
            }
            return 0;
        }
                                        ...
                                        * table_entry)
{
    ...
    T_D("%s: length = %zu", exact ? "GET" : "GET-NEXT", *length);
    memset(table_entry, 0, sizeof(*table_entry));
    ...
    if (*length > op_pos) {
        ...
        /* Because 0 is allowed by ieee8021QBridgeStaticUnicastReceivePort,
           ieee8021QBridgeStaticUnicastTableEntry_get() don't know ieee8021QBridgeStaticUnicastReceivePort is 0 or not assigned,
           the only way is get previous for the other keys
        */
        table_entry->ieee8021QBridgeStaticUnicastReceivePort = 0xffffffff;
        T_D("ieee8021QBridgeStaticUnicastReceivePort is %lu", table_entry->ieee8021QBridgeStaticUnicastReceivePort);
        len = 6;
        cp = (u_char *) table_entry->ieee8021QBridgeStaticUnicastAddress + 6;
        while (len-- > 0) {
            if(*(--cp)) {
                (*cp)--;
                T_D("ieee8021QBridgeStaticUnicastAddress[%zu] is 0x%02x", len, table_entry->ieee8021QBridgeStaticUnicastAddress[len]);
                return 0;
            } else {
                T_D("ieee8021QBridgeStaticUnicastAddress[%zu] is 0x%02x", len, table_entry->ieee8021QBridgeStaticUnicastAddress[len]);
                *(cp) = 0xff;
        ...
        if (table_entry->ieee8021QBridgeStaticUnicastVlanIndex) {
            table_entry->ieee8021QBridgeStaticUnicastVlanIndex--;
            T_D("ieee8021QBridgeStaticUnicastVlanIndex is %lu", table_entry->ieee8021QBridgeStaticUnicastVlanIndex);
            return 0;
        }

        table_entry->ieee8021QBridgeStaticUnicastVlanIndex = 4095;
        if (table_entry->ieee8021QBridgeStaticUnicastComponentId) {
            table_entry->ieee8021QBridgeStaticUnicastComponentId--;
            T_D("ieee8021QBridgeStaticUnicastComponentId is %lu", table_entry->ieee8021QBridgeStaticUnicastComponentId);
            return 0;
        }
        return -1;
    }
                                          ...
                                          * table_entry)
{
        ...
        if (*length > op_pos) {
            *cp++ = (u_char) * op++;
            ...
            do {
                ...
                *(cp--) = 0xff;
                zero_cnt++;
            } while (cp >= (u_char *)table_entry->ieee8021QBridgeStaticMulticastAddress);
            if (zero_cnt == (*length - orig_op_pos + 1)) {
                memset(table_entry->ieee8021QBridgeStaticMulticastAddress, 0, sizeof(table_entry->ieee8021QBridgeStaticMulticastAddress));
                //return 1;
            }
            return 0;
        }
    ...
    if (*length > op_pos) {
        ...
        /* Because 0 is allowed by ieee8021QBridgeStaticMulticastReceivePort,
           ieee8021QBridgeStaticUnicastTableEntry_get() don't know ieee8021QBridgeStaticMulticastReceivePort is 0 or not assigned,
           the only way is get previous for the other keys
        */
        table_entry->ieee8021QBridgeStaticMulticastReceivePort = 0xffffffff;
        len = 6;
        cp = (u_char *) table_entry->ieee8021QBridgeStaticMulticastAddress + 6;
        while (len-- > 0) {
            if(*(--cp)) {
                (*cp)--;
                return 0;
...
#ifdef IEEE8021QBRIDGEPORTMVRPENABLEDSTATUS
...
#endif
#ifdef IEEE8021QBRIDGEPORTMVRPFAILEDREGISTRATIONS
...
#endif
#ifdef IEEE8021QBRIDGEPORTMVRPLASTPDUORIGIN
...
#endif
#ifdef IEEE8021QBRIDGEPORTRESTRICTEDVLANREGISTRATION
                                       ...
                                       oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeTable_entry_t *)
                                        ...
                                        oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeCVlanPortTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                  ...
                                  oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            if (set_value != 0 && (set_value < 10 || set_value > 1000000)) {
                return SNMP_ERR_WRONGVALUE;
            }
            break;
        }
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeFdbTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                           ...
                                           oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeForwardAllTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                                    ...
                                                    size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeForwardUnregisteredTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                                    ...
                                                    size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeStaticUnicastTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                                      ...
                                                      size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeStaticMulticastTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                    ...
                                    oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeVlanStaticTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                         ...
                                         oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            if (set_value != 1  && set_value != 4 && set_value != 6) {
                (void) snmp_log(LOG_ERR,
                          ...
                          u_char * statP, oid * name, size_t name_len)
{
    ...
    case RESERVE1:{
            ...
            if (set_value < 1 || set_value > 4095) {
                return SNMP_ERR_WRONGVALUE;
            }
            break;
        }
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgePortVlanTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                             ...
                                             oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeLearningConstraintsTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                                   ...
                                                   size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeLearningConstraintDefaultsTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                     ...
                                     oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeProtocolGroupTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
                                          ...
                                          oid * name, size_t name_len)
{
    ...
    case RESERVE2:{
            if ((old_table_entry_p = (ieee8021QBridgeProtocolPortTable_entry_t *)
                 ucd_snmp_callout_malloc(sizeof(*old_table_entry_p))) ==
                NULL) {
                return SNMP_ERR_RESOURCEUNAVAILABLE;
            }
