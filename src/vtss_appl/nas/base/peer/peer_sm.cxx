...
#define setAuthorized()                                                \
  do {                                                                 \
    BOOL chgd = PEER_SM(sm)->authStatus != VTSS_APPL_NAS_PORT_STATUS_AUTHORIZED; \
    PEER_SM(sm)->authStatus = VTSS_APPL_NAS_PORT_STATUS_AUTHORIZED;              \
...
#define setUnauthorized()                                                \
  do {                                                                   \
    BOOL chgd = PEER_SM(sm)->authStatus != VTSS_APPL_NAS_PORT_STATUS_UNAUTHORIZED; \
...
void peer_timers_tick(nas_sm_t *sm)
{
    ...
    if (PEER_SM(sm)->reAuthEnabled && PEER_SM(sm)->authStatus == VTSS_APPL_NAS_PORT_STATUS_AUTHORIZED) {
