...
LIST(APPEND CXX_FLAGS "-Werror -Wno-error=deprecated-declarations -Wno-deprecated-declarations")
LIST(APPEND CXX_FLAGS "-ftemplate-backtrace-limit=0")
...
if (${ENABLE_ADDRESS_SANATIZE})
    ...
    LIST(APPEND EXE_LINKER_FLAGS "-fuse-ld=gold")
    LIST(APPEND SHARED_LINKER_FLAGS "-fuse-ld=gold")
endif()
...
message(STATUS "  ld_sh_flags   = ${CMAKE_SHARED_LINKER_FLAGS}")
endif()
