...
#ifndef __VTSS_BASICS_EXPOSE_JSON_STRUCT_WRITE_ONLY_NO_NS_HXX__
#define __VTSS_BASICS_EXPOSE_JSON_STRUCT_WRITE_ONLY_NO_NS_HXX__
...
struct StructWriteOnlyNoNS_;

template <typename INTERFACE, class... Args>
struct StructWriteOnlyNoNS_<INTERFACE, ParamList<Args...>> {
    typedef StructWriteOnlyNoNS_<INTERFACE, ParamList<Args...>> THIS;

    StructWriteOnlyNoNS_(NamespaceNode *p)
        : set_(this, p, "set",
    ...
    virtual ~StructWriteOnlyNoNS_() { set_.unlink(); }

    // Not a bug! FunctionExporterAdd is used to allow default values
    FunctionExporterAdd<INTERFACE, THIS> set_;
};

template <class INTERFACE>
using StructWriteOnlyNoNS =
        StructWriteOnlyNoNS_<INTERFACE, typename INTERFACE::P>;

}  // namespace json
}  // namespace expose
}  // namespace vtss

#endif  // __VTSS_BASICS_EXPOSE_JSON_STRUCT_WRITE_ONLY_NO_NS_HXX__
