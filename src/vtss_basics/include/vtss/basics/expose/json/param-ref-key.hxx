...
#ifndef __VTSS_BASICS_EXPOSE_JSON_PARAM_REF_KEY_HXX__
#define __VTSS_BASICS_EXPOSE_JSON_PARAM_REF_KEY_HXX__
...
template <typename T>
struct ParamRefKeyBase : public ParamRefData<T> {
    ParamRefKeyBase(T *t) : ParamRefData<T>(t) {}
...
template <typename T>
struct ParamRefKey : public ParamRefKeyBase<T> {
    typedef T type;
    typedef T &ref_type;
    typedef T param_as_in_t;
    typedef T param_as_out_t;

    ParamRefKey(T &t) : ParamRefKeyBase<T>(&t) {}
    param_as_in_t param_in_set_context() { return *ParamRefKeyBase<T>::data; }
    param_as_out_t param_in_get_context() { return *ParamRefKeyBase<T>::data; }
};

template <typename T>
struct ParamRefKey<T *> : public ParamRefKeyBase<T> {
    typedef T *type;
    typedef T *ref_type;
...
#endif  // __VTSS_BASICS_EXPOSE_JSON_PARAM_REF_KEY_HXX__
