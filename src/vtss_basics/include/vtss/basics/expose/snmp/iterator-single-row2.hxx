...
#ifndef __VTSS_BASICS_EXPOSE_SNMP_ITERATOR_SINGLE_ROW2_HXX__
#define __VTSS_BASICS_EXPOSE_SNMP_ITERATOR_SINGLE_ROW2_HXX__
...
struct IteratorSingleRow2 : public IteratorCommon {
  public:
    typedef typename Interface2Any<ParamTuple, INTERFACE>::type VALUE;
    ...
    explicit IteratorSingleRow2(GetPtr g)
        : IteratorCommon(MaxAccess::ReadOnly), get_ptr(g), set_ptr(nullptr) {}

    IteratorSingleRow2(GetPtr g, SetPtr s)
...
#endif  // __VTSS_BASICS_EXPOSE_SNMP_ITERATOR_SINGLE_ROW2_HXX__
