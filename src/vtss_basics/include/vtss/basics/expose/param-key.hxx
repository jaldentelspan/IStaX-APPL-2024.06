...
#ifndef __VTSS_BASICS_EXPOSE_PARAM_KEY_HXX__
#define __VTSS_BASICS_EXPOSE_PARAM_KEY_HXX__
...
struct ParamKey {
    ...
    typedef typename meta::OutputType<T>::type get_next_type;
...
#endif  // __VTSS_BASICS_EXPOSE_PARAM_KEY_HXX__
